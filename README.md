...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/patient-moon-a4ce)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/patient-moon-a4ce
```

A live public deployment of this template is available at [https://patient-moon-a4ce.templates.workers.dev](https://patient-moon-a4ce.templates.workers.dev)
